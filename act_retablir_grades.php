...
mysql_query("UPDATE grades SET actif='1' WHERE id='$id'");
mysql_close();
echo "<center>Grade restaur&eacute;</center>";
}
else{ echo "<center>Il y a eu une erreur, rien n'a &eacute;t&eacute; restaur&eacute;</center>";}
?>
