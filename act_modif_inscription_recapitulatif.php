...
?>
<form method="post" action="act_modif_inscription_enregistrement.php?id_inscription=<?php echo $id_inscription; ?>">
...
function recalcule()
{
	...
	document.getElementById('id_0').value = total-id_1-id_2-id_3-id_4;
...
echo "Le montant du ch&egrave;que N°<font color=red><b>1</b></font> sera de <input type=\"text\" name=\"modif_1\" size=\"1\" onkeyup=\"recalcule()\" id=\"id_1\" value=\"".$cheque_1."\" style=\"color : red\"".$moduler_cheque."><font color=red>€.</font></td>";
if($p1_num != 0){echo "<td width=5></td><td>Ch&egrave;que N° <font color=blue>".$p1_num."</font>";}else{echo "<td width=5></td><td>Num&eacute;ro de ch&egrave;que inconnu";}
if($p1_banque != ""){
...
echo "<tr><td>Le montant du ch&egrave;que N°<font color=blue><b>2</b></font> sera de <input type=\"text\" name=\"modif_2\" size=\"1\" onkeyup=\"recalcule()\" id=\"id_2\" value=\"".$cheque_2."\" style=\"color : red\"".$moduler_cheque."><font color=red>€.</font>";
if($p2_num != 0){echo "<td width=5></td><td>Ch&egrave;que N° <font color=blue>".$p2_num."</font>";}else{echo "<td width=5></td><td>Num&eacute;ro de ch&egrave;que inconnu";}
if($p2_banque != ""){
...
echo "<tr><td>Le montant du ch&egrave;que N°<font color=green><b>3</b></font> sera de <input type=\"text\" name=\"modif_3\" size=\"1\" onkeyup=\"recalcule()\" id=\"id_3\" value=\"".$cheque_3."\" style=\"color : red\"".$moduler_cheque."><font color=red>€.</font>";
if($p3_num != 0){echo "<td width=5></td><td>Ch&egrave;que N° <font color=blue>".$p3_num."</font>";}else{echo "<td width=5></td><td>Num&eacute;ro de ch&egrave;que inconnu";}
if($p3_banque != ""){
...
echo "<tr><td>Le montant du ch&egrave;que N°<font color=blue><b>4</b></font> sera de <input type=\"text\" name=\"modif_4\" size=\"1\" onkeyup=\"recalcule()\" id=\"id_4\" value=\"".$cheque_4."\" style=\"color : red\"".$moduler_cheque."><font color=red>€.</font>";
if($p4_num != 0){echo "<td width=5></td><td>Ch&egrave;que N° <font color=blue>".$p4_num."</font>";}else{echo "<td width=5></td><td>Num&eacute;ro de ch&egrave;que inconnu";}
if($p4_banque != ""){
...
function recalcule()
{
	...
	document.getElementById('id_0').value = total-id_1-id_2-id_3;
...
function recalcule()
{
	...
	document.getElementById('id_0').value = total-id_1-id_2;
...
<?php
echo "Le montant du ch&egrave;que N°<font color=red><b>1</b></font> sera de <font color=red>".$cheque_1." €. </font>";
...
$caution_banque = "de la banque <font color=blue>".$_POST["caution_banque"]."</font>";
?>
<input type="hidden" name="caution_banque" value="<?php echo $_POST["caution_banque"]; ?>">
<?php
}else{
$caution_banque = "aucun nom de banque n'a &eacute;t&eacute; renseign&eacute;";
$suivant=0;
}
echo "Une caution sera donn&eacute;e en ch&egrave;que ".$caution_num." ".$caution_banque;
}
elseif($caution == "espece"){
echo "Une caution sera donn&eacute;e en <font color=red>espece</font>";
}}
else{
...
?>
Certificat m&eacute;dical d&eacute;livr&eacute; le : <?php if($certificat_jj<=9){echo"0";} echo $certificat_jj." / "; if($certificat_mm<=9){echo"0";} echo $certificat_mm." / ".$certificat_aaaa."."?>
...
if($suivant == 1){echo "<br><br><input type=\"submit\" value=\"Enregistrer\">&nbsp;&nbsp;&nbsp;<input type=\"button\" value=\"Pr&eacute;c&eacute;dent\" onclick=\"Javascript:history.back();\">";}
