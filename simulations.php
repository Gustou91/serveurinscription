...
<html>
<head>
<title>Simulation de : <?php  echo $membre['nom']." ".$membre['prenom']; ?> </title>
</head>
...
<tr>
<?php
/*$_2_1 = $prix_activite + $prix_frais + $reduc_manu;
$_2_2 = $prix_cours;*/
$_2_1 = round($total / 2, 2);
$_2_2 = round($total / 2, 2);

$_3_1 = $prix_activite + $prix_frais + $reduc_manu;
$_3_2 = (round(($prix_cours)/2));
$_3_3 = (round(($prix_cours)/2));
/*$_3_1 = round($total / 3, 2);
$_3_2 = round($total / 3, 2);
$_3_3 = round($total / 3, 2);*/

$_4_1 = $prix_activite + $prix_frais + $reduc_manu;
$_4_2 = (round(($prix_cours)/3));
$_4_3 = (round(($prix_cours)/3));
$_4_4 = (round(($prix_cours)/3));
/*$_4_1 = round($total / 4, 2);
$_4_2 = round($total / 4, 2);
$_4_3 = round($total / 4, 2);
$_4_4 = round($total / 4, 2);*/

if(($_3_1+$_3_2+$_3_3) != $total)
{
$_3_2 = $_3_2 + ($total-($_3_1+$_3_2+$_3_3));
}

if(($_4_1+$_4_2+$_4_3+$_4_4) != $total)
{
$_4_2 = $_4_2 + ($total-($_4_1+$_4_2+$_4_3+$_4_4));
}
...
<table>
<tr>
<td height=50% style="border:0px;">N°1 : </td><td height=50% style="border:0px;"><?php echo $_4_1;?>€</td>
</tr>
<tr>
<td height=50% style="border:0px;">N°2 : </td><td height=50% style="border:0px;"><?php echo $_4_2;?>€</td>
</tr>
<tr>
<td height=50% style="border:0px;">N°3 : </td><td height=50% style="border:0px;"><?php echo $_4_3;?>€</td>
</tr>
<tr>
<td height=50% style="border:0px;">N°4 : </td><td height=50% style="border:0px;"><?php echo $_4_4;?>€</td>
</tr>
</table>
</td></tr>
</table>
...
<table border="1" cellpadding=10 cellspacing=0>
	<caption ALIGN=top><h2>Mode de calcul</h2></caption>
	<tr><th>Paiement en une fois:</th><td aligne="left">Intégralité de la somme due.</td></tr>
	<tr><th>Paiement en deux fois:</th><td aligne="left">Premier paiement: Moitié de la somme due.<br>Deuxième paiement: Moitié de la somme due.</td></tr>
	<tr><th>Paiement en trois fois:</th><td aligne="left">Premier paiement: Licences + réductions + cotisation + écusson<br>Deuxième paiement: Moitié des cours.<br>Troisième paiement: Moitié des cours.</td></tr>
	<tr><th>Paiement en quatre fois:</th><td aligne="left">Premier paiement: Licences + réductions + cotisation + écusson<br>Deuxième paiement: Tiers des cours.<br>Troisième paiement: Tiers des cours.<br>Quatrième paiement: Tiers des cours.</td></tr>
</table>
...
<br>Il reste à régler : <input type="text" name="modif_total" size="2" id="id_0" value="<?php echo $total; ?>" readonly="readonly"> €
<br><br>Cheque N°1 : <input type="text" name="modif_1" size="2" onkeyup="recalcule()" id="id_1"> €
<br>Cheque N°2 : <input type="text" name="modif_2" size="2" onkeyup="recalcule()" id="id_2"> €
<br>Cheque N°3 : <input type="text" name="modif_3" size="2" onkeyup="recalcule()" id="id_3"> €
<br>Cheque N°4 : <input type="text" name="modif_4" size="2" onkeyup="recalcule()" id="id_4"> €
</center>
</body>
</html>