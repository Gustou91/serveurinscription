...
<?php
		...
		if(($parametre['valeur'])=="OUI"){
			echo " ";
			if($inscription['jour']<=9){
				echo "0";
			};
			echo $inscription['jour']." / ";
			if($inscription['mois']<=9){
				echo "0";
			};
...
<?php
	...
	$parametre = mysql_fetch_array($parametre);
	echo nl2br (stripslashes($parametre['valeur']));
	$parametre = mysql_query("SELECT * FROM generale WHERE nom = 'date_4'");
	$parametre = mysql_fetch_array($parametre);
	if(($parametre['valeur'])=="OUI"){
		echo " ";
		if($inscription['jour']<=9){
...
<?php
$parametre = mysql_query("SELECT * FROM generale WHERE nom = 'sous_ligne_contrat_04'");
$parametre = mysql_fetch_array($parametre);
echo nl2br (stripslashes($parametre['valeur']));
?>
</td></tr>
